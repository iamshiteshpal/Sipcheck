...
<head>
  <meta charset="utf-8">
  <title>{fund_name} - CAS 360 Report</title>
  <style>
...
<body>
  <div class="header-bar">
    <div class="cas-logo">CAS 360 · Mutual Fund Report</div>
  ...
  <div class="footer">
    <b>Disclaimer:</b> This report is generated by CAS 360 for informational purposes only.
    ...
    SEBI Registration required for investment advice. CAS 360 is not a SEBI-registered advisor.
  </div>
</body>
</html>"""
...
with col_dl1:
    st.download_button(
        ...
        file_name=f"CAS360_{selected.replace(' ','_')[:30]}_{datetime.now().strftime('%Y%m%d')}.html",
        mime="text/html",
...
<div style="margin-top:32px;padding-top:16px;border-top:1px solid #1e2338;
  ...
  <b>Disclaimer:</b> This report is generated by CAS 360 for informational and educational purposes only.
  ...
  mfapi.in, and publicly available fund factsheets. CAS 360 is not a SEBI-registered investment advisor.
