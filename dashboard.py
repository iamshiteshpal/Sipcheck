    ...
    <div style="max-width:860px;margin:0 auto;padding:0 16px;">
      ...
      <div style="text-align:center;margin-bottom:44px;">
        <div style="font-family:'Syne',sans-serif;font-size:22px;font-weight:800;
          ...
          Your mutual fund portfolio, finally in one clear view.
        </div>
        <div style="font-size:14px;color:#718096;line-height:1.85;max-width:620px;margin:0 auto;">
          ...
          no syncing, no data leaving your browser.
        </div>
      </div>
      ...
      <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:16px;margin-bottom:44px;">
        ...
        <div style="background:#0c0f1a;border:1px solid rgba(99,179,237,0.12);border-radius:14px;
          ...
          <div style="font-size:12px;color:#718096;line-height:1.7;">
            Total wealth, unrealized P&L, SIP monthly outflow and asset allocation —
            all at a glance with live NAV refresh.
          </div>
        </div>
        ...
        <div style="background:#0c0f1a;border:1px solid rgba(99,179,237,0.12);border-radius:14px;
          ...
          <div style="font-size:12px;color:#718096;line-height:1.7;">
            Every holding broken down by category — Equity, Debt, Gold & Commodities,
            International — with XIRR, NAV, and live value.
          </div>
        </div>
        ...
        <div style="background:#0c0f1a;border:1px solid rgba(99,179,237,0.12);border-radius:14px;
          ...
          <div style="font-size:12px;color:#718096;line-height:1.7;">
            Active and stopped SIPs side by side. Monthly outflow chart,
            next due dates, and bounce detection built in.
          </div>
        </div>
        ...
        <div style="background:#0c0f1a;border:1px solid rgba(99,179,237,0.12);border-radius:14px;
          ...
          <div style="font-size:12px;color:#718096;line-height:1.7;">
            Full transaction history per scheme — purchase, redemption, switch,
            dividend — with XIRR table across all holdings.
          </div>
        </div>
        ...
        <div style="background:#0c0f1a;border:1px solid rgba(99,179,237,0.12);border-radius:14px;
          ...
          <div style="font-size:12px;color:#718096;line-height:1.7;">
            Auto-detects stopped SIPs, unrealized losses, and duplicate
            SIP entries so nothing slips through unnoticed.
          </div>
        </div>
        ...
        <div style="background:#0c0f1a;border:1px solid rgba(99,179,237,0.12);border-radius:14px;
          ...
          <div style="font-size:12px;color:#718096;line-height:1.7;">
            Parsed entirely in-session. Nothing is stored on any server.
            Close the tab and your data is gone — zero data retention.
          </div>
        </div>
      ...
      <div style="background:#0c0f1a;border:1px solid rgba(99,179,237,0.10);border-radius:16px;
        ...
        <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:12px;text-align:center;">
          <div>
            ...
            <div style="font-size:11px;color:#718096;">Request from CAMS or KFintech portal — it arrives by email as a PDF</div>
          </div>
          <div>
            ...
            <div style="font-size:11px;color:#718096;">Drop the PDF above and enter the password (PAN or date of birth)</div>
          </div>
          <div>
            ...
            <div style="font-size:11px;color:#718096;">Your full portfolio parses in seconds — no waiting, no signup</div>
          </div>
          <div>
            ...
            <div style="font-size:11px;color:#718096;">Hit "Refresh Latest NAV" to pull real-time values from AMFI</div>
          </div>
        </div>
      </div>
